miica_ind_calc <- function(name_studysite, list_stacks){
...
list_10m <- list_stacks[[1]]
list_20m <- list_stacks[[2]]
...
dNBR_plot <- paste0("dNBR of ", name_studysite, ".png")
dNDVI_title <- paste0("dNDVI of ", name_studysite)
dNDVI_plot <- paste0("dNDVI of ", name_studysite, ".png")
CV_title <- paste0("CV of ", name_studysite)
CV_plot <- paste0("CV of ", name_studysite, ".png")
RCVMAX_title <- paste0("RCVMAX of ", name_studysite)
RCVMAX_plot <- paste0("RCVMAX of ", name_studysite, ".png")
...
for (i in 1:(length(list_20m)-1)){
  ...
  name_dNBR <- paste0(name_studysite, " dNBR ",  names(list_20m)[i], " to ", names(list_20m)[j])
...
for (i in 1:(length(list_20m)-1)){
  ...
  name_dNDVI <- paste0(name_studysite, " dNDVI ",  names(list_20m)[i], " to ", names(list_20m)[j])
...
for (i in 1:(length(list_20m)-1)){
  ...
  name_CV <- paste0(name_studysite, " CV ",  names(list_20m)[i], " to ", names(list_20m)[j])
...
for (i in 1:(length(list_20m)-1)){
  ...
  name_RCVMAX <- paste0(name_studysite, " RCVMAX ",  names(list_20m)[i], " to ", names(list_20m)[j])
